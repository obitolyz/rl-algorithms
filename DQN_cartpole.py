...
class DQN(object):
    ...
    def learn(self):
        ...
        q_s_ = self.target_net(batch_s_).detach()  # detach from graph, don't backpropagate
        q_target = batch_r + GAMMA * torch.max(q_s_, 1)[0].view(BATCH_SIZE, 1)
